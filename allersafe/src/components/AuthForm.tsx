    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-[#0E2A06]">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-[#9DE26B] mt-3 text-sm font-medium">
            {signup ? '14 days free · no payment for 2 weeks · cancel anytime' : 'Welcome back'}
          </p>
        </div>
            ...
            <div className="space-y-4">
              <div>
                <h1 className="text-xl font-bold text-gray-900">
                  {signup ? 'Start your free trial' : 'Sign in'}
                </h1>
        ...
        <p className="text-center text-sm text-[#C0DD97] mt-6">
          {signup ? (
            <>Already using AllerSafe?{' '}
              <Link href="/login" className="font-semibold text-white hover:underline">Sign in</Link>
            </>
          ) : (
            <>New here?{' '}
              <Link href="/signup" className="font-semibold text-white hover:underline">Start your free trial</Link>
            </>
          )}
          {' '}·{' '}
          <Link href="/pricing" className="font-semibold text-white hover:underline">Plans &amp; pricing</Link>
        </p>
      </div>
    </div>
  );
